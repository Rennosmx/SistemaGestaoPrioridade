	...
	private void cadastrar(){
		...
		if(idCadastro == "M�dico") {				
			...
			if (crm.getText().isEmpty()) {
				JOptionPane.showMessageDialog(null, "Informe um CRM para o M�dico", 
						"Erro", JOptionPane.ERROR_MESSAGE);
				return;		
			} else if(!crm.getText().matches("[0-9]*")){
				JOptionPane.showMessageDialog(null, "O CRM deve conter apenas n�meros", 
						"Erro", JOptionPane.ERROR_MESSAGE);
				return;
			}
			if (especialidade.getText().isEmpty()) {
				JOptionPane.showMessageDialog(null, "Informe uma especialidade para o M�dico", 
						"Erro", JOptionPane.ERROR_MESSAGE);
				return;		
			}

			//INSER��O NAS TABELAS DO USUARIO M�DICO
			...
			if (numProntuario.getText().isEmpty()) {
				JOptionPane.showMessageDialog(null, "Informe o Prontu�rio para o Paciente", 
						"Erro", JOptionPane.ERROR_MESSAGE);
				return;		
			} else if(!numProntuario.getText().matches("[0-9]*")){
				JOptionPane.showMessageDialog(null, "O Prontuario deve conter apenas n�meros", 
						"Erro", JOptionPane.ERROR_MESSAGE);
				return;
			}
			...
			//INSER��O NAS TABELAS DO USU�RIO PACIENTE
			...
			//INSER��O NAS TABELAS DO USUARIO RECEPCIONISTA
